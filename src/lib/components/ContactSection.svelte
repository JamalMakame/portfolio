<script>
   ...
   import PricePlans from "./PricePlans.svelte";
...
<section class="flex flex-col justify-center items-center -my-10">
   <div class="container my-24 px-6 mx-auto">
      ...
      <section class="mb-32 text-gray-800">
         ...
         <div
            class="block rounded-lg shadow-lg bg-white-card-background dark:bg-dark-card-background"
         >
                  ...
                  <div class="flex flex-wrap pt-12 lg:pt-0">
                     ...
                     >
                        <div class="flex items-start">
                           <div class="shrink-0">
                              <div
                                 class="p-4 bg-yellowClr rounded-md shadow-md w-14 h-14 flex items-center justify-center"
                              >
                                 <svg
                                    aria-hidden="true"
                                    focusable="false"
                           ...
                           <div class="grow ml-6">
                              <p
                                 class="font-bold mb-1 text-black dark:text-white"
                              >
                                 Technical support
                              </p>
